...
class ProductPage(BasePage):
    ...
    def add_product_to_basket(self):
        ...
        name_error = f'Incorrect name of a product in notification. Should \
            be {product_name} but {notif_product_name}.'
        price_error = f'Incorrect price of a product in notification. Should \
            be {product_price} but {notif_product_price}.'
